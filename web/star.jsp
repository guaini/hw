...
<script>
    ...
    function start() {
        ...
        axios.get("http://43.139.215.45:80/api/Index?action=favor_list", {headers: {Authorization: ` ${localStorage.getItem("token")}`}}).then(render_star);
        axios.get("http://43.139.215.45:80/api/Index?action=upload_list", {headers: {Authorization: ` ${localStorage.getItem("token")}`}}).then(render_upload);
    }
